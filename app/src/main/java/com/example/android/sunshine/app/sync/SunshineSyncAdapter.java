...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks {
    ...
    private void updateWearable() {
        ...
        if (cursor.moveToFirst()) {
            ...
            String min=Utility.formatTemperature(context, low);
            String max=Utility.formatTemperature(context, high);
            // Define the text of the forecast.


            SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);

            String previousMin=prefs.getString(context.getString(R.string.pref_previous_min_temperature),"");
            String previousMax= prefs.getString(context.getString(R.string.pref_previous_max_temperature),"");
            int previousWeather= prefs.getInt(context.getString(R.string.pref_previous_weather_temperature),-1);

            if(!previousMin.equals(min) ||
                    !previousMax.equals(max)||
                    weatherId!=previousWeather){

                SharedPreferences.Editor editor = prefs.edit();
                editor.putString(context.getString(R.string.pref_previous_min_temperature),min);
                editor.putString(context.getString(R.string.pref_previous_max_temperature),max);
                editor.putInt(context.getString(R.string.pref_previous_weather_temperature),weatherId);
                editor.commit();



                Intent intent= new Intent(getContext(),SunshineSyncWearable.class);
